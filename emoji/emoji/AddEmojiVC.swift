...
class AddEmojiVC: UITableViewController, UITextFieldDelegate{
    
    override func viewDidLoad() {
        super.viewDidLoad()
        self.tableView = UITableView(frame: CGRect.zero, style: .grouped)
        tableView.register(AddEmojiCellVC.self, forCellReuseIdentifier: "addEmoji")//register cell
        buttons()
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "addEmoji", for: indexPath) as! AddEmojiCellVC
